...
This is a minor mode to make lisp butts appear slim.
...
*** hint to remove this font-lock keyword in a buffer
...
the above is just a hint how to realize the disabling programatically.

e.g. the code did not change the representation of the lisp butts
immediately.  newly written lisp butts were left alone, though.

** Tasks

*** Open

**** TODO Write cleanly to switch on/off for a file

Hint: Currently the realization is a bit weird.

**** TODO Provide a global variant
